  ...
  <div class="productCard">
    <div class="avatar">
      <div class="verticalCentered">
        <div class="theCell"><img :src="(contest['photo'] && contest['photo']['photo_name']) || 'images/img5.jpg'" alt=""></div>
      </div>
    </div>
    <div class="content">
      <h3>
    ...
    <CardActions :likeable="true" :is-liked="contest.is_liked" :commentable="true" :sharable="true" :obj-id="contest.id" :num-of-likes="contest.likes" :num-of-comments="contest.comments" context="contest" />
  </div>
</template>
<script>
