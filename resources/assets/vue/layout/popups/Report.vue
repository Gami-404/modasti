            ...
            <div class="content">
                <div v-if="!upload">
                    ...
                    <ul class="report-reasons">
                        ...
                        <li><a href="javascript:void(0)" :class="{'active':title==='Copying other sets'}"
                               @click="title='Copying other sets';others=false">Copying
                            other sets</a></li>
                        <li><a href="javascript:void(0)" :class="{'active':title==='Privacy Violation'}"
                               @click="title='Privacy Violation';others=false">Privacy
                            Violation</a></li>
                        <li><a href="javascript:void(0)" :class="{'active':title==='Adult content'}"
                               @click="title='Adult content';others=false">Adult
                            content</a></li>
                        ...
                        <li><a href="javascript:void(0)" :class="{'active':title==='Racist and hate speech'}"
                               @click="title='Racist and hate speech';others=false">Racist
                            and hate speech.</a>
                        </li>
                        <li><a href="javascript:void(0)" :class="{'active':title==='Using photos of others.'}"
                               @click="title='Using photos of others.';others=false">Using
                            photos of
                            others.</a></li>
                        <li><a href="javascript:void(0)" :class="{'active':others}" @click="title='';others=true">Others.</a>
                        </li>
                    </ul>
                    <br>
                    <br>
