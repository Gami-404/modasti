        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <h2>
                    ...
                    {{ $collection->id ? trans("posts::collections.edit") : trans("posts::collections.add_new") }}
                </h2>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li>
                        <a href="{{ route("admin.posts.collections.show") }}">{{ trans("posts::collections.posts") }}</a>
                    </li>
                    <li class="active">
                        <strong>
                            {{ $collection->id ? trans("posts::collections.edit") : trans("posts::collections.add_new") }}
            ...
            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 text-right">
                ...
                @if ($collection->id)
                    <a href="{{ route("admin.posts.collections.create") }}" class="btn btn-primary btn-labeled btn-main"> <span
                        ...
                        {{ trans("posts::collections.add_new") }}</a>
                @endif

                <button type="submit" class="btn btn-flat btn-danger btn-main">
                    <i class="fa fa-download" aria-hidden="true"></i>
                    {{ trans("posts::collections.save_post") }}
                </button>
                ...
                <div class="col-md-8">
                    <div class="panel panel-default">
                        ...
                        <textarea name="title" class="form-control input-lg" rows="1" id="post_title"
                                  placeholder="{{ trans("posts::collections.attributes.title") }}">{{ @Request
                                ::old("title", $collection->title) }}</textarea>
                            </div>

                            <div class="form-group">
                        <textarea name="excerpt" class="form-control" id="post_excerpt"
                                  placeholder="{{ trans("posts::collections.attributes.excerpt") }}">{{ @Request
                                ::old("excerpt", $collection->excerpt) }}</textarea>
                            </div>

                            <div class="form-group">
                                @include("admin::partials.editor", ["name" => "content", "id" => "postcontent", "value" => $collection->content])
                            </div>

                        </div>
                    </div>

                    @foreach(Action::fire("post.sets.form.featured", $collection) as $output)
                        {!!  $output !!}
                    @endforeach
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            {{ trans("posts::collections.post_status") }}
                        </div>
                        <div class="panel-body">
                            <div class="form-group switch-row">
                                <label class="col-sm-9 control-label"
                                       for="input-front_page">{{ trans("posts::collections.attributes.front_page") }}</label>
                                <div class="col-sm-3">
                                    <input type="checkbox"
                                           @if (@Request::old("front_page", $collection->front_page)) checked="checked"
                            ...
                            <div class="form-group date-time-pick">
                                <div class="input-group date datetimepick">
                                    ...
                                    <input name="published_at" type="text"
                                           value="{{ (!$collection->id) ? date("Y-m-d H:i:s") : @Request::old('published_at', $collection->published_at) }}"
                                           class="form-control" id="input-published_at"
                                           placeholder="{{ trans("posts::collections.attributes.published_at") }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            {{ trans("posts::collections.add_image") }}
                        ...
                        <div class="panel-body form-group">
                            <div class="row post-image-block">
                                ...
                                <a class="change-post-image label" href="javascript:void(0)">
                                    ...
                                    {{ trans("posts::collections.change_image") }}
                                </a>

                                <a class="post-media-preview" href="javascript:void(0)">
                                    <img width="100%" height="130px" class="post-image"
                                         src="{{ ($collection and @$collection->image) ? thumbnail($collection->image->path) : assets("admin::default/image.png") }}">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <?php echo trans("posts::collections.items"); ?>
                        </div>
                        <div class="panel-body">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".change-post-media").filemanager({
                ...
                error: function (media_path) {
                    alert_box("{{ trans("posts::collections.not_media_file") }}");
                }
            });
